...
function addRow(value, tag) {
  ...
  rowId.push(elid);
  el.id = elid;
  el.innerHTML = `<td><input type="text" value="${value}" onmouseover="this.select()" style="width:-webkit-fill-available;font-family:monospace;"></td><td><button onclick="remove('${elid}');">×</button></td>`;
